...
export function Onboarding() {
  return (
    <div className="flex flex-col gap-8 min-h-dvh mt-4">
      <div className="flex-1 px-6 pb-12">
        <div className="flex justify-center">
          <Empty className="border md:p-6 md:flex-none from-muted/50 to-background h-full bg-gradient-to-b from-30%">
            <EmptyHeader>
            ...
            <EmptyContent className="min-w-0 w-full max-w-lg">
              <NpssoStepper />
            </EmptyContent>
          </Empty>
        </div>
